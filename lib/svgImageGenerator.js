...
<svg width="800" height="400" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <!-- Logo ATOMIC FLIX style néon dans le cercle -->
  <g clip-path="url(#logoClip)">
    <!-- Atome stylisé (cercles entrelacés) -->
    <circle cx="200" cy="160" r="25" fill="none" stroke="#ff6b6b" stroke-width="3" opacity="0.8" transform="rotate(45 200 160)"/>
    <circle cx="200" cy="160" r="25" fill="none" stroke="#4ecdc4" stroke-width="3" opacity="0.8" transform="rotate(-45 200 160)"/>
    <circle cx="200" cy="160" r="25" fill="none" stroke="#45b7d1" stroke-width="3" opacity="0.8"/>
    
    <!-- Triangles de lecture style néon -->
    <polygon points="190,150 210,160 190,170" fill="#ff6b6b" opacity="0.9" filter="url(#glow)"/>
    
    <!-- Centre du logo -->
    <circle cx="200" cy="160" r="8" fill="url(#animeGradient)" filter="url(#glow)"/>
    
    <!-- Lettre F stylisée -->
    <text x="215" y="168" font-family="Arial Black, sans-serif" font-size="20" font-weight="bold" fill="#4ecdc4" filter="url(#glow)">F</text>
  </g>
